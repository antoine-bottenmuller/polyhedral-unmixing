...
###
# Main function to compute distance from point 'p' to polyhedron 'Psi_h'
###

def __f0(h_original:np.ndarray, q:np.ndarray, h:np.ndarray, U:np.ndarray, eps:float=1e-6, steps=[], step=0) -> Tuple[np.ndarray, bool]:
    # p_original = 0
...
def __f1(h_original:np.ndarray, q:np.ndarray, h:np.ndarray, U:np.ndarray, eps:float=1e-6, steps=[], step=0) -> Tuple[np.ndarray, bool]:
    # p_original = 0
    # NO condition on family (v_i)_i
    steps.append(step)
...
def __f2(h_original:np.ndarray, q:np.ndarray, h:np.ndarray, U:np.ndarray, eps:float=1e-6, steps=[], step=0) -> Tuple[np.ndarray, bool]:
    # p_original = 0
    # NO condition on family (v_i)_i
    steps.append(step)
...
def __f3(h_original:np.ndarray, q:np.ndarray, h:np.ndarray, U:np.ndarray, eps:float=1e-6, steps=[], step=0) -> Tuple[np.ndarray, bool]:
    # p_original = 0
    # NO condition on family (v_i)_i
    steps.append(step)
...
###
# WOLFE algorithm (works on vertices only!)
###
